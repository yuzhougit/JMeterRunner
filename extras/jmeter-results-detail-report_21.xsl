		...
		<head>
			...
			<script language="JavaScript"><![CDATA[
			   ...
			   function change(details_id)
			   {
			      ...
			      {
			         document.getElementById(details_id+"_image").src = "../resources/collapse.png";
			         expand(details_id);
			      }
			      else
			      {
			         document.getElementById(details_id+"_image").src = "../resources/expand.png";
			         collapse(details_id);
			      } 
                           }
			]]></script>
...
<xsl:template name="pageHeader">
	...
	<table width="100%">
		<tr>
			...
			<td align="right">Designed for use with <a href="http://jmeter.apache.org/">JMeter</a> modified by e-testing</a>.</td>
		</tr>
	</table>
	<hr size="1" />
</xsl:template>
